...
const AgentSettings: React.FC = () => {
  const [agentId, setAgentId] = useState(import.meta.env.VITE_ELEVENLABS_AGENT_ID || 'agent_01jyncdvaxfqn8kdqk5rfn1jdt'); // Load from environment variable or fallback
