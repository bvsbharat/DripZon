...
const ProductDisplay: React.FC = () => {
  ...
  useEffect(() => {
    const isLoading = loading || isProductDetailLoading;
  ...
  if (!selectedProduct) {
    return (
      <motion.div
        className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 flex items-center justify-center h-[590px] shadow-2xl"
  ...
  // Show loading state when category is switching or products are loading
  if (debouncedLoading) {
    return (
      <motion.div
      ...
      >
        ...
        >
          ...
          <div className="relative w-full h-full rounded-lg border border-white/10 overflow-hidden">
            {/* Main image skeleton with horizontal shimmer */}
            <div className="w-full h-full bg-white/5 relative overflow-hidden">
              ...
              {/* Try-on button skeleton (top-right) */}
              <div className="absolute top-4 right-4">
                <div className="w-12 h-12 bg-white/8 rounded-full relative overflow-hidden">
                  <motion.div
              ...
              {/* Thumbnail navigation skeleton (bottom-right) */}
              <div className="absolute bottom-8 right-7">
                <div className="flex flex-col gap-2 bg-black/10 backdrop-blur-md rounded-full p-2">
                  {[...Array(3)].map((_, index) => (
                    <div
                      key={index}
                      className="w-12 h-12 bg-white/8 rounded-full relative overflow-hidden"
                    >
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent"
                        animate={{
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center space-y-4">
                  {/* Main icon skeleton */}
                  <div className="w-20 h-20 bg-white/8 rounded-full mx-auto relative overflow-hidden">
                    <motion.div
                  ...
                  <div className="space-y-2">
                    <div className="h-3 bg-white/8 rounded-full w-40 mx-auto relative overflow-hidden">
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent"
                        animate={{
                          x: ["-100%", "100%"],
                    ...
                    <div className="h-3 bg-white/6 rounded-full w-32 mx-auto relative overflow-hidden">
                      <motion.div
                    ...
                    <div className="h-2 bg-white/4 rounded-full w-24 mx-auto relative overflow-hidden">
                      <motion.div
                ...
                {selectedProduct?.category === "Clothing" && (
                  <div className="absolute top-4 right-4 group/tooltip">
                    <motion.button
                      ...
                      disabled={isTryingOn}
                      className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 backdrop-blur-xl border-3 border-blue-400/60 hover:border-blue-300/80 rounded-full text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center group shadow-lg shadow-blue-500/40"
