            ...
            <div className="flex items-center gap-3">
              ...
              {isTryEnabled && (
                <button
                  ...
                  disabled={isTryingOn}
                  className={`px-6 py-4 bg-white/20 hover:bg-white/30 backdrop-blur-xl rounded-2xl text-white font-semibold transition-all duration-300 border border-white/40 hover:border-white/60 text-lg flex items-center gap-2 shadow-lg shadow-white/20 ${
                    isTryingOn
              ...
              <button
                ...
                className="px-10 py-4 bg-white/15 hover:bg-white/25 backdrop-blur-xl border border-white/30 hover:border-white/40 text-white font-semibold rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-white/20 text-lg"
              >
                Add to cart
              </button>
            </div>
