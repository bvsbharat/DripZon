...
const Logo: React.FC<LogoProps> = ({
  ...
  return (
    <div
      className={`relative font-bold text-white tracking-wide bg-opacity-20 px-6 py-3 text-3xl md:text-3xl ${sizeClasses[size]} ${className}`}
    >
      <span className={`${textClassName} transform scale-110`}>Dripify</span>
    </div>
  );
};
