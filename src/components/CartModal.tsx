          ...
          <div className="p-6">
            {orderConfirmed ? (
              ...
              <div className="text-center py-8">
                ...
                <button
                  onClick={handleClose}
                  className="mt-6 w-full bg-white/15 hover:bg-white/25 backdrop-blur-xl border border-white/30 hover:border-white/40 text-white font-semibold py-3 px-6 rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-white/20"
                >
                  Continue Shopping
                </button>
              </div>
                  ...
                  <>
                    ...
                    <div className="mt-6 pt-4 border-t border-white/10">
                      ...
                      <button
                        ...
                        className="w-full bg-black/40 hover:bg-black/50 backdrop-blur-xl border border-black/30 hover:border-black/40 text-white font-semibold py-3 px-6 rounded-2xl transition-all duration-300 hover:shadow-2xl hover:shadow-black/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                      >
                        {isCheckingOut ? (
                          <>
